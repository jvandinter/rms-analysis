...
plus="/hpc/pmc_vanheesch/projects/Jip/rms_analysis/02_riboseq/analysis/merged_psites/patient/plus"
minus="/hpc/pmc_vanheesch/projects/Jip/rms_analysis/02_riboseq/analysis/merged_psites/patient/minus"
...
$bedtools unionbedg -i ${plus}/*aRMS*.sorted.bedgraph > ${plus}/RMS_FP_merged.sorted.bedgraph
$bedtools unionbedg -i ${plus}/*eRMS*.sorted.bedgraph > ${plus}/RMS_FN_merged.sorted.bedgraph
...
$bedtools unionbedg -i ${minus}/*aRMS*.sorted.bedgraph > ${minus}/RMS_FP_merged.sorted.bedgraph
$bedtools unionbedg -i ${minus}/*eRMS*.sorted.bedgraph > ${minus}/RMS_FN_merged.sorted.bedgraph
