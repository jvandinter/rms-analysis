...
fasta_locs = grep("TIS",list.dirs("/hpc/pmc_vanheesch/projects/Jip/rms_analysis/02_riboseq/analysis/ORFquant", recursive = F), value = T)
savedir = "/hpc/pmc_vanheesch/projects/Jip/rms_analysis/02_riboseq/results"
interesting_orfs = read.delim(paste(savedir,"patient","RMS_patient_all_ORFs.txt",sep="/"), sep =";")
savefile = paste(savedir,"patient","patient_sequence_table.txt", sep = "/")
