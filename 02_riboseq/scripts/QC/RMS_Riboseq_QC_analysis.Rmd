...
savedir = "/hpc/pmc_vanheesch/projects/Jip/rms_analysis/02_riboseq/results/QC"
...
cds_reads_df <- dplyr::mutate(cds_reads_df,group = c(rep("ORG",32),rep("TUM",19)))
frame_perc_plot <- perc_reads_df %>%
  dplyr::mutate(group = c(rep("ORG",32),rep("TUM",19))) %>%
...
inframe_df$group <- c(rep("ORG",32),rep("TUM",19))
