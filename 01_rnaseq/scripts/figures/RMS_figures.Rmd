...
save_dir = paste(rna_dir,"results/quantification/figures",sep="/")
metadata_dir = paste(rna_dir,"documentation",sep="/")
txome_gtf = paste(basedir,
...
rds_loc = paste(basedir,"analysis","quantification", sep = "/")
```
...
dds <- readRDS(paste(rna_dir,"analysis","quantification","deseq2","RMS_counts_combined.RDS",sep="/"))
